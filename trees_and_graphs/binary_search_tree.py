...
class Node(object):
    ...
    def replace_node(self, key, value, left_child, right_child):
        self.key = key
        self.payload = value
        ...
        if current_node.is_leaf():
            ...
            if current_node.has_left_child():
                if current_node.is_left_child():
                    ...
                    current_node.replace_node(current_node.left_child.key, current_node.left_child.payload,
                ...
                if current_node.is_left_child():
                    ...
                    current_node.replace_node(current_node.right_child.key, current_node.rightchild.payload,
